...
We recommend using homebrew to install most up-to-date version of the `make`. Keep in mind `make` is keg-only, and you'll need to manually add its location to the `PATH`.
